...
{
    addtea = new addteacherdialog(this);
    addtea->show();
}

void EmployeeMainDialog::on_pushButton_removeTeacher_clicked()
{
    rmvteadialog = new removeteacherdialog();
    rmvteadialog->show();
}

void EmployeeMainDialog::on_pushButton_exit_clicked()
{
    this->close();
}
...
{
    editteadialog = new editteacherdialog();
    editteadialog->show();
}
